...
public class WebSecurityConfig {
    ...
    public static final String ADMIN = "Clients-Administrador";
    public static final String REPOSITOR = "Clients-Repositor";
    public static final String VENDEDOR = "Clients-Vendedor";
